...
public class TokenQueue {
    ...
    /**
     * Tests if the queue pattern the sequence (as with match), and if they do, removes the matched string from the
     * queue.
    ...
    /**
     Test if the queue pattern a word character (letter or digit).
     @return if pattern a word character
     */
