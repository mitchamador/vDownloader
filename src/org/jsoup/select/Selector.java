 ...
 * <tr><td><code>:pattern(<em>regex</em>)</code></td><td>elements whose text pattern the specified regular expression. The text may appear in the found element, or any of its descendants.</td><td><code>td:pattern(\\d+)</code> finds table cells containing digits. <code>div:pattern((?i)login)</code> finds divs containing the text, case insensitively.</td></tr>
 ...
 * <tr><td><code>:matchesOwn(<em>regex</em>)</code></td><td>elements whose own text pattern the specified regular expression. The text must appear in the found element, not any of its descendants.</td><td><code>td:matchesOwn(\\d+)</code> finds table cells directly containing digits. <code>div:matchesOwn((?i)login)</code> finds divs containing the text, case insensitively.</td></tr>
